...
1.  text strings: These strings are used to represent all textual data,
    ...
    six.Text (which is `str` in python 3 and `unicode` in python 2).
...
import six
from six import Text, binary_type
...
class ModelReprMixin(object):
    ...
    Define __unicode__ on your model which returns a six.Text object.
